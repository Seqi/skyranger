let propertyBag = function() {
	this.properties = [
		...
		},
		{
			...
			type: 'NameProperty',
			isGenderSpecific: true,
			maleVals: ['CnvMed_Std_A_M', 'CnvMed_Std_B_M', 'CnvMed_Std_C_M', 'CnvMed_Std_D_M'],
			femaleVals: ['CnvMed_Std_A_F', 'CnvMed_Std_B_F', 'CnvMed_Std_C_F', 'CnvMed_Std_D_F']
		},
		{
			name: 'nmArms',
			type: 'NameProperty',
		...
		},
		{
			...
			type: 'NameProperty',
			isGenderSpecific: true,
			maleVals: ['CnvUnderlay_Std_Torsos_A_M'],
			femaleVals: ['CnvUnderlay_Std_A_F']
		},
		{
			name: 'nmArms_Underlay',
			type: 'NameProperty',
			isGenderSpecific: true,
			maleVals: ['CnvUnderlay_Std_Arms_A_M'],
			femaleVals: ['CnvMed_Underlay_A_F']
		},
		{
			name: 'nmLegs_Underlay',
			type: 'NameProperty',
			isGenderSpecific: true,
			maleVals: ['CnvUnderlay_Std_Legs_A_M'],
			femaleVals: ['CnvUnderlay_Std_A_F']
		},
		{
			name: 'nmFacePaint',
